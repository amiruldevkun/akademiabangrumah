    ...
    SvelteKitPWA({
      ...
      manifest: {
        ...
        icons: [
          ...
          { src: '/assets/pwa-512x512.png', sizes: '512x512', type: 'image/png', purpose: 'any' },
          { src: '/assets/maskable-icon-512x512.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' }
        ],
        screenshots: [
          { src: '/assets/images/Desktop_Richer.png', sizes: '1920x1080', type: 'image/png', form_factor: 'wide' },
          { src: '/assets/images/Phone_Richer.png', sizes: '1080x1920', type: 'image/png', form_factor: 'narrow' }
        ]
      },
    }),
  ],
