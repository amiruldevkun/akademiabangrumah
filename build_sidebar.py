...
def render_section(title, items, is_first_section=False):
    lines = []
    lines.append('        <div class="lesson-section space-y-2">')
    lines.append(f'            <div class="lesson-section-title bg-white text-black font-semibold px-3 py-1.5 rounded text-center shadow-sm">{esc(title)}</div>')
    lines.append('            <ul class="pl-2 space-y-1 text-sm text-slate-200">')
