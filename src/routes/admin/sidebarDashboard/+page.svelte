<script lang="ts">
	// src/routes/admin/sidebar/+page.svelte
...
<div class="mx-auto max-w-3xl p-6 space-y-6">
	...
	>
		<div class="space-y-2">
			...
			<label class="block">
				<span class="text-sm font-medium">...or paste the exported Google Doc text directly</span>
				<textarea
					name="rawText"
					bind:value={rawText}
					rows="14"
	...
	{#if parsedSections}
		...
		<div class="rounded border border-gray-200 p-4 space-y-4">
			...
			<a href="/classroom" hidden={!form?.pushed} class="rounded bg-green-700 px-4 py-2 text-white mb-1 disabled:opacity-50">
